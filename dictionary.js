...
(function () {
  ...
  panel.innerHTML = `
    <div class="dictHead">
      ...
      <button type="button" class="dictClose" aria-label="Wörterbuch schließen">✕</button>
    </div>
    <label class="dictSearch"><span aria-hidden="true">⌕</span><input type="search" autocomplete="off" autocapitalize="off" spellcheck="false" placeholder="z. B. kava, Bahnhof, hvala …"></label>
  ...
  function run() {
    ...
    hits.forEach(({ e, dir }) => {
      ...
      row.innerHTML = `
        ...
        <button type="button" class="dictSpeak" aria-label="${esc(e.hr)} anhören">🔊</button>`;
