const CACHE="korak-v5-2026-07";const FILES=["./","./index.html","./styles.css","./app.js","./course-data.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
