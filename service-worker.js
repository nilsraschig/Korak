const CACHE="korak-v8-2026-09";const FILES=["./","./index.html","./styles.css","./app.js","./course-data.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
