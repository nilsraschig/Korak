const CACHE="korak-v12-2026-09";
const FILES=["./","./index.html","./styles.css","./config.js","./cloud.js","./app.js","./account.js","./dictionary.js","./vala.js","./coast.js","./sound.js","./course-data.js","./culture-data.js","./exercise-data.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
