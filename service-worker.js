...
const FILES=["./","./index.html","./styles.css","./config.js","./cloud.js","./app.js","./account.js","./dictionary.js","./course-data.js","./manifest.webmanifest","./icon-192.png","./icon-512.png","./apple-touch-icon.png"];
